export declare const reservedVars: {
    arguments: boolean;
    NaN: boolean;
};
export declare const ecmaIdentifiers: {
    3: {
        Array: boolean;
        Boolean: boolean;
        Date: boolean;
...
export declare const browserify: {
    __filename: boolean;
    __dirname: boolean;
    global: boolean;
    module: boolean;
...
export declare const prototypejs: {
    "$": boolean;
    "$$": boolean;
    "$A": boolean;
    "$F": boolean;
